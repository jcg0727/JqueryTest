 ...
 */
//httpservletRequest를 감싸서 새로운기능 덧붙임(보조스트림처럼)
//파일업로드일때는 그 기능쓰고 아닐때는 원래기능. 이거 안쓰면 아예새로 만들어야되서(request객체 아예 다른모습)
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
    ...
    private Map<String, String[]> parameterMap;			// 폼필드(파라미터) 데이터를 담기 위한 맵  //multipart로 오는 것 parsing된거 넣어줌
     ...
     */
    public FileUploadRequestWrapper(HttpServletRequest request) //원래객체(기반객체)  
    throws FileUploadException{
     ...
     */
    public void addTo() {
      super.setAttribute(FileUploadRequestWrapper.class.getName(), this);  //kr.or.ddit.~이렇게 쓰기 싫어서(이름에 패키지명까지 포함되있음)
    }
